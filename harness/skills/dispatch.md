...
3. Recent Slack thread (if a slack entity is linked) — fetch last 10 messages:
   ...
   ```
4. Available skills list: sync-state, poll-notion, poll-slack, poll-github, entity-registry, dispatch, post-slack-message, e2e-test
...
- harness/skills/post-slack-message.md
